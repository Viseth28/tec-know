    ...
    <div className="max-w-6xl mx-auto space-y-6 pb-24 animate-in fade-in duration-500">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="bg-white rounded-[2.5rem] shadow-xl border border-gray-100 overflow-hidden">
            <div className="p-6 bg-blue-600 text-white flex items-center justify-between">
              <div className="flex items-center">
                ...
                <h3 className="text-lg font-bold">Staging Configuration</h3>
              </div>
              <div className="flex items-center bg-blue-700/50 px-3 py-1.5 rounded-lg border border-blue-400/30">
                <input 
                  type="checkbox" 
                  id="batchMode" 
                  checked={isBatchMode} 
            ...
            <div className="p-8 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      required
                      maxLength={15}
                      className="w-full px-4 py-3 rounded-xl border-2 border-transparent bg-white focus:border-blue-500 font-mono text-xl outline-none transition-all shadow-sm"
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                ...
                <button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-2xl font-black flex items-center transition-all shadow-xl shadow-blue-100 active:scale-95 text-xs uppercase tracking-widest disabled:opacity-50"
                >
          ...
          {/* Staged Indicator */}
          {isSuccess && (
            <div className="bg-green-600 text-white px-8 py-4 rounded-[2rem] flex items-center justify-center animate-in slide-in-from-bottom-6 shadow-2xl shadow-green-100">
          ...
          <div className="bg-white rounded-[2rem] shadow-xl border border-gray-100 overflow-hidden flex flex-col h-full max-h-[calc(100vh-160px)]">
            <div className="p-6 bg-slate-900 text-white flex items-center justify-between shrink-0">
              <div className="flex items-center">
                ...
                <h3 className="text-lg font-bold">Registration Queue</h3>
              </div>
            ...
            <div className="p-8 flex-1 overflow-y-auto space-y-6">
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {queue.length === 0 ? (
                    <div className="py-24 border-2 border-dashed border-gray-50 rounded-[2rem] flex flex-col items-center justify-center text-gray-300">
                      <Barcode size={48} className="mb-3 opacity-10" />
                      <p className="text-[10px] font-black uppercase tracking-widest text-center px-6">Queue Empty</p>
                      <p className="text-[9px] font-medium text-gray-400 mt-1 uppercase">Configure model & scan IMEIs to stage</p>
                    </div>
                  ) : (
                    queue.map((p, idx) => (
                      <div key={p.id} className="bg-slate-50 px-5 py-4 rounded-2xl border border-slate-100 flex items-center justify-between group hover:bg-white hover:shadow-md transition-all animate-in slide-in-from-right-4">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1.5">{p.brand} • {p.imei1.slice(-4)}</p>
                          </div>
                        </div>
                        <button 
            ...
            {queue.length > 0 && (
              <div className="p-8 border-t border-slate-100 bg-slate-50/50 shrink-0">
                ...
                <button
                  ...
                  className="w-full py-5 bg-slate-900 hover:bg-black text-white rounded-2xl font-black flex items-center justify-center transition-all shadow-xl shadow-slate-200 active:scale-95 text-xs uppercase tracking-[0.2em] gap-3"
                >
                  {isProcessing ? (
